...
// 使用 prompt 结合 claude api 生成社交卡片
class SocialCard extends Template {
  final String prompt = """
  // 作者：一泽Eze
  // 名称：个人社交名片生成器
...
""";
  ...
  @override
  TemplateProperty get templateProperty => TemplateProperty(prompt, name: "个人社交名片生成器", author: "一泽Eze", description: "收集用户的个人简介，生成美观的个人社交名片");
